...
export function ProductDetailPage({
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mb-2 md:mb-3">
                    ...
                    <div className="flex items-center gap-1 md:gap-1.5 flex-wrap">
                      <span style={{ fontSize: '13px', color: '#0F1111', fontWeight: 'bold' }}>{(recommendedProduct.rating ?? 0).toFixed(1)}</span>
                      <div className="flex items-center">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Star
                            key={i}
                            className={`size-3 md:size-3.5 ${
                              i < Math.floor((recommendedProduct.rating ?? 0))
                                ? "fill-[#ffa41c] text-[#ffa41c]"
                                : "text-[#D5D9D9]"
                            }`}
                          />
  ...
  {/* Product Details */}
  <div id="product-details" className="mb-6 bg-white border border-[#D5D9D9] p-4 md:p-6 rounded-lg">
